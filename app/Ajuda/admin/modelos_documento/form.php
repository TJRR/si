...
return [
    ...
    'operacoes' => [
        [
            ...
            'como' => 'Use as palavras-chave `[[marcador]]` do painel/dicionário lateral para inserir dados que variam por equipe (ex.: nome da equipe, nome do líder).',
            'observacao' => 'O servidor rejeita salvar se o texto contiver um marcador não reconhecido: a mensagem de erro lista qual.',
        ],
        [
