...
return [
    ...
    'resumo' => 'Cada Etapa é uma fase do processo dentro de uma Trilha (ex.: "Cadastro de Equipe", "Classificatória", "Final"), com seu próprio período, regra de passagem para a próxima etapa e configuração de avaliação.',
    'operacoes' => [
        [
        ...
        [
            ...
            'como' => 'Manual (Admin confirma o corte antes de liberar) ou Automático (assim que as notas de todas as submissões estiverem completas, o resultado é publicado sozinho, disparado automaticamente a partir do próprio lançamento da última nota, sem depender de nenhuma rotina agendada em segundo plano).',
        ],
        [
            'nome' => 'Salvar',
