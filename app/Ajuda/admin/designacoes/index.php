...
return [
    ...
    'operacoes' => [
        [
            'nome' => 'Filtrar por avaliador/situação',
            'como' => 'Reduz a lista para conferir uma pessoa ou situação específica.',
        ],
        [
            'nome' => 'Atribuir aos selecionados',
            'como' => 'Marque submissões via caixa de seleção, escolha o avaliador no seletor, e clique no botão para atribuir em massa (modo manual).',
        ],
        [
        ...
        [
            ...
            'como' => 'Só aparece em modo sorteio por categoria: hiperlink para configurar quantas vagas cada categoria tem nesta etapa.',
        ],
    ],
