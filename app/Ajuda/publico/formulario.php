...
return [
    ...
    'operacoes' => [
        ...
        [
            ...
            'observacao' => 'Reenviar atualiza a submissão existente; não cria uma duplicata. Envio de PDF tem limite de 15MB. O acesso a esta tela segue as mesmas regras do painel do participante: equipe homologada, dentro do prazo, e classificada na etapa anterior (se houver corte).',
        ],
    ],
    'conceitos' => [],
];
