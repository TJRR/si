...
return [
    ...
    'resumo' => 'Lista de submissões desta etapa que estão sob sua responsabilidade, com uma etiqueta própria de progresso por submissão ("X/Y critérios", ou "Resultado publicado" quando a etapa já foi encerrada), visual diferente da etiqueta de situação comum do resto do sistema e específica desta fila do avaliador.',
    'operacoes' => [
        [
