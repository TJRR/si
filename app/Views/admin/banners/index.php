...
<div class="pagina-titulo-acoes">
    ...
    <div class="pagina-titulo-botoes">
        <a href="<?php echo url('banners/novo'); ?>" class="btn-acao">+ Nova faixa</a>
    </div>
</div>
    ...
    <ul class="reordenar-lista" data-reordenar-rota="banners/reordenar">
        ...
        <li class="reordenar-item" draggable="true" data-id="<?php echo (int) $banner['id']; ?>">
            ...
            <div class="acoes-icones">
                ...
                <form method="post" action="<?php echo url('banners/remover'); ?>" onsubmit="return confirm('Remover esta faixa?');"><?= campoCsrf() ?>
