...
<?php else: ?>
    <ul class="reordenar-lista" data-reordenar-rota="eventoSlides/reordenar/<?php echo (int) $evento['id']; ?>">
        ...
        <li class="reordenar-item" draggable="true" data-id="<?php echo (int) $slide['id']; ?>">
            ...
            <div class="acoes-icones">
                <a href="<?php echo url('eventoSlides/editar/' . (int) $slide['id']); ?>" class="btn-icone" title="Editar">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
                        <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path>
                        <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
                    </svg>
                </a>
                <form method="post" action="<?php echo url('eventoSlides/remover'); ?>" onsubmit="return confirm('Remover este quadro?');"><?= campoCsrf() ?>
            ...
            <div class="reordenar-botoes">
                ...
                <button type="button" class="btn-icone" data-mover="baixo" aria-label="Mover para baixo" <?php echo $indice === count($slides) - 1 ? 'disabled' : ''; ?>>▼</button>
            </div>
        </li>
        <?php endforeach; ?>
    </ul>
