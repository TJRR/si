        ...
        <tr>
            ...
            <td>
                ...
                <div class="acoes-icones">
                    ...
                    <form method="post" action="<?php echo url('concursos/remover'); ?>" onsubmit="return confirm('Remover este concurso? Só funciona se ele ainda não tiver trilhas, formulários ou categorias de avaliador vinculados.');"><?= campoCsrf() ?>
