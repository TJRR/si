...
<?php
// buscarPorId() e' SELECT * (sem join com equipes) - o nome da equipe vem
// dos proprios convidados, ja resolvidos a partir do equipe_id do slot.
$nomeEquipe = !empty($convidados) ? $convidados[0]['nome_equipe'] : null;
?>
<p>
    <strong>Apresentação de pitch
        <?php if ($nomeEquipe !== null): ?>
            da equipe <?php echo htmlspecialchars($nomeEquipe, ENT_QUOTES, 'UTF-8'); ?>
        <?php else: ?>
