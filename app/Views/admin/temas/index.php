    ...
    <ul class="reordenar-lista" data-reordenar-rota="temas/reordenar/<?php echo (int) $trilha['id']; ?>">
        ...
        <li class="reordenar-item" draggable="true" data-id="<?php echo (int) $tema['id']; ?>">
            ...
            <div class="acoes-icones">
                ...
                <?php if (\App\Core\Auth::possuiPerfil('administrador')): ?>
                <form method="post" action="<?php echo url('temas/remover'); ?>" onsubmit="return confirm('Remover este tema? Só funciona se ele não tiver desafios cadastrados.');"><?= campoCsrf() ?>
            ...
            <div class="reordenar-botoes">
                ...
                <button type="button" class="btn-icone" data-mover="baixo" aria-label="Mover para baixo" <?php echo $indice === count($temas) - 1 ? 'disabled' : ''; ?>>▼</button>
            </div>
        </li>
        <?php endforeach; ?>
    </ul>
