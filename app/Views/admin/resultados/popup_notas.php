...
<?php else: ?>
    <?php foreach ($notasPorAvaliador as $grupo): ?>
        ...
        <table border="1" cellpadding="6" style="margin-bottom:1.5em;">
            <tr><th>Critério</th><th>Nota</th><th>Comentário</th></tr>
            <?php foreach ($grupo['notas'] as $nota): ?>
                <tr>
                    ...
                    <td><?php echo !empty($nota['feedback']) ? nl2br(htmlspecialchars($nota['feedback'], ENT_QUOTES, 'UTF-8')) : 'Não informado'; ?></td>
                </tr>
            <?php endforeach; ?>
        </table>
    <?php endforeach; ?>
