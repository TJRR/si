...
<h1>Histórico de versões: <?php echo htmlspecialchars($evento['nome'], ENT_QUOTES, 'UTF-8'); ?></h1>
<p><a href="<?php echo url('eventoDocumentos/index/' . (int) $evento['id']); ?>" class="btn-voltar">Voltar aos documentos</a></p>
