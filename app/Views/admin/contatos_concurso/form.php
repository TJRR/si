...
<div class="pagina-titulo-acoes">
    <h1>Contato de <?php echo htmlspecialchars($concurso['nome'], ENT_QUOTES, 'UTF-8'); ?></h1>
    <div class="pagina-titulo-botoes">
        <a href="<?php echo url('contatosConcurso/mensagens/' . (int) $concurso['id']); ?>" class="btn-acao">Ver mensagens recebidas</a>
    </div>
</div>

<form method="post" action="<?php echo url('contatosConcurso/index/' . (int) $concurso['id']); ?>">
