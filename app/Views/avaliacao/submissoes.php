...
<h1>Submissões da etapa <?php echo htmlspecialchars($etapa['nome'], ENT_QUOTES, 'UTF-8'); ?></h1>
...
<?php else: ?>
    <table border="1" cellpadding="6">
        <tr><th>Equipe</th><th>Situação</th><th>Ações</th></tr>
        ...
        <tr>
            <td>
                ...
                <?php else: ?>
                    <?php echo htmlspecialchars($submissao['nome_equipe'] !== null ? $submissao['nome_equipe'] : 'Nome não informado', ENT_QUOTES, 'UTF-8'); ?>
                <?php endif; ?>
            </td>
            <td>
