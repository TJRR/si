...
<div class="site-page">
    ...
    <div class="site-form-page">
        ...
        <p>Lista de horários de mentoria, apenas para transparência: o agendamento é feito pelo painel de cada equipe.</p>

        <?php if (empty($horarios)): ?>
            <p><em>Nenhum horário de mentoria cadastrado ainda.</em></p>
        <?php else: ?>
            <table border="1" cellpadding="6">
                <tr><th>Mentor</th><th>Início</th><th>Fim <?php echo sufixoFusoHorario(); ?></th><th>Observação</th><th>Situação</th></tr>
